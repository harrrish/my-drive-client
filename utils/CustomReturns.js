...
export const dirCreatedSuccess = "Directory created";
...
//* FRONT END ERRORS !
export const getDirError = "Unknown Error occured while fetching contents";
export const createDirError = "Unknown Error while creating folder";
export const renameDirError = "Unknown Error while renaming folder";
export const deleteDirError = "Unknown Error while deleting folder";

export const uploadFileError = "Unknown Error while uploading file";
export const renameFileError = "Unknown Error while renaming file";
export const deleteFileError = "Unknown Error while deleting file";
